...
<h2>Description</h2>
This project consists of a simple home network that walks the user through connecting and configuring devices that are connected to the network securely. The utility allows you to virtually create the network system in a controlled environment before creating it in the real world.
<br />
